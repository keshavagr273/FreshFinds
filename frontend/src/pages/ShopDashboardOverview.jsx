        ...
        <main className="flex-1 p-6">
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-2">
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                <h2 className="mb-6 text-lg font-semibold text-slate-900">Sales Trend</h2>
                <div className="flex h-64 items-center justify-center rounded-lg bg-slate-50">
                  <p className="text-slate-500">Chart placeholder - Sales trend over time</p>
                </div>
              </div>
              
              <div className="rounded-2xl bg-white p-6 shadow-sm">
                <h2 className="mb-6 text-lg font-semibold text-slate-900">Category Performance</h2>
                <div className="flex h-64 items-center justify-center rounded-lg bg-slate-50">
                  <p className="text-slate-500">Chart placeholder - Category breakdown</p>
                </div>
              </div>
            </div>
          </div>
